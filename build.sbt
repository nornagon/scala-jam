...
lazy val root = (project in file(".")).
  settings(
    ...
    libraryDependencies += "org.bytedeco.javacpp-presets" % "skia" % "20170514-53d6729-1.3.3-SNAPSHOT",
    libraryDependencies += "org.bytedeco.javacpp-presets" % "skia" % "20170514-53d6729-1.3.3-SNAPSHOT" classifier "macosx-x86_64",
    libraryDependencies += "org.bytedeco.javacpp-presets" % "liquidfun" % "20150401-0708ce1-1.3.3-SNAPSHOT",
    libraryDependencies += "org.bytedeco.javacpp-presets" % "liquidfun" % "20150401-0708ce1-1.3.3-SNAPSHOT" classifier "macosx-x86_64",
